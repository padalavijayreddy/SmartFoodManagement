...
export const Input = styled(Typo14Steel60HKGroteskRegular)`
   border: none;
   margin: 10px;
   outline: none;
`
...
export const ReviewFood = styled.div`
   ${tw`w-full`}
   margin-bottom:30px;
`

export const ReviewDiv = styled(Typo32DarkBlueGreyHKGroteskMedium)`
    ${tw``}
    border-bottom:1px solid ${colors.brightBlue};
    padding-bottom:10px;
`

export const QualityDiv = styled(Typo20BlackHKGroteskMedium)`
   ${tw`text-2xl`}
   padding-bottom:10px;
   margin-right: 10px;
   margin-left: 15px;
...
export const TasteDiv = styled(Typo20BlackHKGroteskMedium)`
   ${tw`text-2xl`}
   padding-bottom:10px;
   margin-right: 130px;
   margin-left: 45px;
...
export const SecondDiv = styled.div`
   ${tw`flex w-full justify-around m-10 items-center`}
`
