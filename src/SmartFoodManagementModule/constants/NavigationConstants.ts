...
export const SMART_FOOD_MANAGEMENT_REVIEW_PATH =
   '/Smart-Food-Management/review/:mealType'
export const WEEKLY_MENU_PATH = '/Smart-Food-Management/weeklyMenu/'
export const ADMIN_PORTAL_PATH = '/Smart-Food-Management/adminPortal'
