...
export const Typo32DarkBlueGreyRubikRegular = styled.p`
   ...
   Typo12SteelHKGroteskRegular = styled.div`
      ...
      color: #7e858e;
   `,
   Typo14DarkBlueGreyHKGroteskRegular = styled.button`
      font-family: HKGrotesk;
      font-size: 20px;
      font-weight: 500;
      font-stretch: normal;
   ...
   `,
   Typo20DarkBlueGreyHKGrotesk = styled.span`
      font-family: HKGrotesk;
      font-size: 20px;
      font-weight: 500;
      font-stretch: normal;
      ...
      color: ${colors.lightBlueGrey};
   `,
   Typo20BlackHKGroteskMedium = styled.button`
      width: 143px;
      height: 24px;
      font-family: HKGrotesk;
      font-size: 14px;
   ...
   Typo14DarkBlueGreyHKGroteskSemiBold = styled.button`
      ...
      color: ${colors.lightBlueGrey};
   `,
   Typo32DarkBlueGreyHKGroteskMedium = styled.div`
      font-family: HKGrotesk;
      font-size: 32px;
      font-weight: 500;
      font-stretch: normal;
